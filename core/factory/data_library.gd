...
static func _copy_extras(from_module: AbilityModule, to_module: AbilityModule) -> void:
	...
	to_module.relocate_subject_only = from_module.relocate_subject_only
	to_module.relocate_target = from_module.relocate_target
	to_module.move_active_totem = from_module.move_active_totem
	to_module.curse_of_weakness = from_module.curse_of_weakness
	to_module.stat_str = from_module.stat_str
	to_module.stat_def = from_module.stat_def
	to_module.push_mitigation_zero = from_module.push_mitigation_zero
	to_module.totem_kind = from_module.totem_kind
	to_module.pulse_aoe = from_module.pulse_aoe
	to_module.pulse_heal = from_module.pulse_heal
	to_module.pulse_cleanse = from_module.pulse_cleanse
	to_module.pulse_mag_atk = from_module.pulse_mag_atk
	to_module.pulse_fire = from_module.pulse_fire
	to_module.bloodlust = from_module.bloodlust
	to_module.bloodlust_def = from_module.bloodlust_def
	to_module.bloodlust_mov = from_module.bloodlust_mov
	to_module.bloodlust_hp = from_module.bloodlust_hp
	to_module.bloodlust_bleed_on_attack = from_module.bloodlust_bleed_on_attack
	to_module.hex = from_module.hex
	to_module.wither = from_module.wither
	to_module.boss_damage_reduction = from_module.boss_damage_reduction
	to_module.hex_vulnerable = from_module.hex_vulnerable
	to_module.voodoo_link = from_module.voodoo_link
	to_module.shared_damage_wpn = from_module.shared_damage_wpn
	to_module.shared_push = from_module.shared_push
	to_module.terrify = from_module.terrify
	to_module.boss_fallback_purge_shield = from_module.boss_fallback_purge_shield
	to_module.boss_fallback_vulnerable = from_module.boss_fallback_vulnerable
	to_module.poison_spread_on_push_collision = from_module.poison_spread_on_push_collision
	to_module.bone_spear = from_module.bone_spear
	to_module.ghost_duration = from_module.ghost_duration
	to_module.echo_next_cast = from_module.echo_next_cast
	to_module.ghost_hp_pct = from_module.ghost_hp_pct
	to_module.echo_upgraded = from_module.echo_upgraded
	to_module.ranged_reduction = from_module.ranged_reduction
	to_module.melee_def = from_module.melee_def
	to_module.sympathetic_bond = from_module.sympathetic_bond
	to_module.link_ally_enemy = from_module.link_ally_enemy
	to_module.ally_heal_enemy_wpn = from_module.ally_heal_enemy_wpn
	to_module.enemy_damage_ally_heal = from_module.enemy_damage_ally_heal
	to_module.bonus_damage_per_debuff = from_module.bonus_damage_per_debuff
	to_module.heal_per_debuff = from_module.heal_per_debuff
	to_module.pain_spike = from_module.pain_spike
	to_module.linked_enemy_damage = from_module.linked_enemy_damage
	...
	to_module.arrival_overclock = from_module.arrival_overclock
	to_module.target_def_pct_loss = from_module.target_def_pct_loss
	to_module.on_hit_scrap = from_module.on_hit_scrap
	to_module.ignite_oil_area = from_module.ignite_oil_area
	to_module.construct_spawn = from_module.construct_spawn
	to_module.turret_attack = from_module.turret_attack
	to_module.on_death_adjacent_damage = from_module.on_death_adjacent_damage
	to_module.ignite_oil = from_module.ignite_oil
	to_module.construct_destruction_refund_ap = from_module.construct_destruction_refund_ap
	to_module.mine_pull = from_module.mine_pull
	to_module.mine_damage = from_module.mine_damage
	to_module.mine_explode = from_module.mine_explode
	to_module.absorbs_items_scrap = from_module.absorbs_items_scrap
	to_module.tesla_wall = from_module.tesla_wall
	to_module.manual_detonation_stagger = from_module.manual_detonation_stagger
	to_module.scrap_attack_bonus = from_module.scrap_attack_bonus
	to_module.scrap_bleed_weapon = from_module.scrap_bleed_weapon
	to_module.wrench_smack = from_module.wrench_smack
	to_module.wrench_strength_bonus = from_module.wrench_strength_bonus
	to_module.emp_grenade = from_module.emp_grenade
	to_module.mechanical_boss_damage_wpn = from_module.mechanical_boss_damage_wpn
	to_module.emp_friendly_construct_heal = from_module.emp_friendly_construct_heal
	to_module.emp_friendly_construct_overclock = from_module.emp_friendly_construct_overclock
	to_module.rocket_launcher = from_module.rocket_launcher
	to_module.exhaust_next_turn = from_module.exhaust_next_turn
	to_module.sacrifice_construct_instant = from_module.sacrifice_construct_instant
	to_module.scrap_shield = from_module.scrap_shield
	to_module.scrap_multiplier = from_module.scrap_multiplier
	to_module.shield_depletion_explode = from_module.shield_depletion_explode
	to_module.manual_detonation = from_module.manual_detonation
	to_module.refund_scrap = from_module.refund_scrap
	to_module.overdrive_injection = from_module.overdrive_injection
	to_module.construct_unmitigated_damage = from_module.construct_unmitigated_damage
	to_module.refund_scrap_on_construct_death = from_module.refund_scrap_on_construct_death
