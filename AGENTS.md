...
- **Subagent Council Loop (absolute):** Before applying gameplay/planning fixes — **propose → 5 rules critics (parallel) → 5/5 PASS → apply** (+ critics 6–7 when QA-fix or class scope). NOT Gauntlet. See `docs/qa/SUBAGENT_COUNCIL_LOOP.md`.
