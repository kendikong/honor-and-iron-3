...
- **Subagent Council Loop (absolute):** Before applying gameplay/planning fixes — **propose → 3 rules-only critics → 3/3 PASS → apply**. NOT Gauntlet Loop. See `.cursor/rules/subagent-council-loop.mdc` and `docs/qa/SUBAGENT_COUNCIL_LOOP.md`.
