...
Write-GateLine "Spec: docs/CLASS_QA_BIBLE.md (instance: docs/ENGINEER_QA_GATE.md)"
Write-GateLine ""
...
Write-GateLine "=== Matrix summary (from docs/ENGINEER_QA_GATE.md) ==="
...
if (Test-Path $manifestPath) {
	...
	Write-GateLine "[WARN] Missing manifest: docs/engineer_meta_critic_manifest.json"
}
