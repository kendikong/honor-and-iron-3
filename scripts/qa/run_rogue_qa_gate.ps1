...
Write-GateLine "Spec: docs/qa/CLASS_QA_BIBLE.md (instance: docs/qa/classes/ROGUE_QA_GATE.md)"
Write-GateLine ""
...
Write-GateLine "=== Matrix summary (from docs/qa/classes/ROGUE_QA_GATE.md) ==="
...
if (Test-Path $manifestPath) {
	...
	Write-GateLine "[WARN] Missing manifest: docs/qa/manifests/rogue_meta_critic_manifest.json"
}
...
$process = Start-Process -FilePath $GodotPath `
	-ArgumentList "--headless --path `"$projectRoot`" res://tests/gates/RogueQaGate.tscn" `
