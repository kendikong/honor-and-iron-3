...
$matrixDoc = Join-Path $projectRoot "docs\qa\classes\KNIGHT_QA_GATE.md"
$manifestPath = Join-Path $projectRoot "docs\qa\manifests\knight_meta_critic_manifest.json"

$latestGateLog = Join-Path $projectRoot "reports\qa\qa_knight_gate_latest.txt"
$canonicalGateLog = Join-Path $projectRoot "reports\qa\qa_knight_gate_canonical.txt"
...
Write-GateLine "Spec: docs/qa/CLASS_QA_BIBLE.md (instance: docs/qa/classes/KNIGHT_QA_GATE.md)"
Write-GateLine ""
...
Write-GateLine "=== Matrix summary (from docs/qa/classes/KNIGHT_QA_GATE.md) ==="
...
if (Test-Path $manifestPath) {
	...
	Write-GateLine "[WARN] Missing manifest: docs/qa/manifests/knight_meta_critic_manifest.json"
}
...
$process = Start-Process -FilePath $GodotPath `
	-ArgumentList "--headless --path `"$projectRoot`" res://tests/gates/KnightQaGate.tscn" `
