...
2. **Subagent Council Loop** — **5 parallel rules critics** (6–7 if QA-fix or class scope); see [`docs/qa/SUBAGENT_COUNCIL_LOOP.md`](../../qa/SUBAGENT_COUNCIL_LOOP.md). **All PASS** → apply.
