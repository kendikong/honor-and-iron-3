...
**Loop contract:** `docs/design/logs/PLANNING_GAUNTLET_LOOP.md`  
**Owner rules:** `docs/design/MOVE_PREVIEW_RULES.md` · **Agent log:** `docs/design/logs/MOVE_PREVIEW_IMPLEMENTATION_LOG.md` · **Matrix:** `docs/design/PLANNING_REFACTOR_MATRIX.md`  
...
|----|----------|-------------------|-----|--------|----------------------|--------------|----------------|
| *(none — all HIGH/MED gaps closed through round 33)* |
...
| GAP-010 | MED | `_planning_phase_allows_live_path_stand` label fork vs movement-step gate | `39aea42b3` | 32 |
| GAP-011 | MED | Swap approach used `base_board` instead of `preview_board` | `39aea42b3` | 32 |
| GAP-012 | MED | Action-range live-path tail without movement-step guard | `39aea42b3` | 32 |
...
| 2026-08-30 | Round 33: GAP-013–016 closed — suppress flag removed; `_apply_post_commit_hover_truth`; overlay-only sim throttle defer; stand-anchor API restored |
