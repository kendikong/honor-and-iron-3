...
| [`planning/MOVE_PREVIEW_RULES.md`](planning/MOVE_PREVIEW_RULES.md) | **ACTIVE — dominant** Owner rules — planning hover, paths, tiles, commit |
| [`planning/MOVE_PREVIEW_IMPLEMENTATION_LOG.md`](planning/MOVE_PREVIEW_IMPLEMENTATION_LOG.md) | Agent build diary — pass history (not rules) |
| [`planning/ACTION_RANGE_LATEST_STAND.md`](planning/ACTION_RANGE_LATEST_STAND.md) | Red tiles from latest stand — failure log |
