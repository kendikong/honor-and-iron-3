...
**Scope:** Class validation — every **active skill**, **movement skill**, and **passive** in `core/factory/classes/<class>_factory.gd` behaves per `class_abilities.txt` § <Class>. **Not** gameplay-core planning/UI (see [`PLANNING_QA_GATE.md`](../planning/PLANNING_QA_GATE.md)).
...
**Clone authority:** [`docs/qa/CLASS_QA_BIBLE.md`](../CLASS_QA_BIBLE.md) (universal spec) · [`docs/qa/classes/KNIGHT_QA_GATE.md`](KNIGHT_QA_GATE.md) (reference instance) · [`.cursor/rules/class-qa-knight-bar.mdc`](../../../.cursor/rules/class-qa-knight-bar.mdc)
...
| **Manual** | `docs/qa/planning/PLANNING_SKILL_QA_CHECKLIST.md` per ability | Required for feel/pixels Tier 1–2 cannot see |
