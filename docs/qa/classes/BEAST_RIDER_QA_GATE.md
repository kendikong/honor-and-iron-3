...
Source of truth: `class_abilities.txt` §6 and `docs/qa/CLASS_QA_BIBLE.md`.
...
- [ ] F5: Pounce, Bestial Roar, Raking Claws, Intimidate, Tail Swipe, and Gore
  red overlays match their Bible footprints.
