...
**Scope:** Class validation for `Lancer` — Push movement skill, 13 active skills, 15 promotion passives (`class_abilities.txt`). **Not** gameplay-core planning/UI (see [`PLANNING_QA_GATE.md`](../planning/PLANNING_QA_GATE.md)).
...
| **Manifest** | `docs/qa/manifests/lancer_meta_critic_manifest.json` |
...
| **Manual** | `docs/qa/planning/PLANNING_SKILL_QA_CHECKLIST.md` | Required for feel/pixels |

---

## Meta-critic

Same as [`KNIGHT_QA_GATE.md`](KNIGHT_QA_GATE.md) § Meta-critic. **Manifest:** `docs/qa/manifests/lancer_meta_critic_manifest.json`.
