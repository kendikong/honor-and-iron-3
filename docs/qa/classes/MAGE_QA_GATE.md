...
**Scope:** Class validation — Mage factory, 15 actives + Blink + 15 passives + innate (`class_abilities.txt` §7). **Not** gameplay-core planning/UI (see [`PLANNING_QA_GATE.md`](../planning/PLANNING_QA_GATE.md)).
...
| **Manifest** | `docs/qa/manifests/mage_meta_critic_manifest.json` |
...
Same as [`KNIGHT_QA_GATE.md`](KNIGHT_QA_GATE.md) § Meta-critic. **Manifest:** `docs/qa/manifests/mage_meta_critic_manifest.json`.
