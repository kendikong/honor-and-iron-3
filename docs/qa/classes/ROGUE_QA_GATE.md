...
Manifest: [`docs/qa/manifests/rogue_meta_critic_manifest.json`](rogue_meta_critic_manifest.json) — updated after each critic round ≥ 88.
...
| Manual | `docs/qa/planning/PLANNING_SKILL_QA_CHECKLIST.md` | Required for feel/pixel checks |
