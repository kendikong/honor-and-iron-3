...
| **Bruiser** | Complete | **NOT PASS** | [`BRUISER_QA_GATE.md`](BRUISER_QA_GATE.md) | `run_bruiser_qa_gate.ps1` | **Missing** | B6 sign-off **revoked** — redo per Knight bar (Tier 2 live + overlay/AOE footprints) |
