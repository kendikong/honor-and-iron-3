...
static func run_overwatch(failures: Array[String]) -> void:
	H.assert_true(failures, "overwatch/mod", H.factory_passive(&"overwatch") != null)


static func run_high_ground(failures: Array[String]) -> void:
	H.assert_true(failures, "high_ground/mod", H.factory_passive(&"high_ground") != null)
...
static func run_piercing_momentum(failures: Array[String]) -> void:
	H.assert_true(failures, "piercing_momentum/mod", H.factory_passive(&"piercing_momentum") != null)


static func run_camouflage(failures: Array[String]) -> void:
	H.assert_true(failures, "camouflage/mod", H.factory_passive(&"camouflage") != null)


static func run_area_denial(failures: Array[String]) -> void:
	H.assert_true(failures, "area_denial/mod", H.factory_passive(&"area_denial") != null)


static func run_caltrop_expert(failures: Array[String]) -> void:
	H.assert_true(failures, "caltrop_expert/mod", H.factory_passive(&"caltrop_expert") != null)
...
static func run_sticky_mud(failures: Array[String]) -> void:
	H.assert_true(failures, "sticky_mud/mod", H.factory_passive(&"sticky_mud") != null)


static func run_fletching_hoarder(failures: Array[String]) -> void:
	H.assert_true(failures, "fletching_hoarder/mod", H.factory_passive(&"fletching_hoarder") != null)


static func run_prey_sighted(failures: Array[String]) -> void:
	H.assert_true(failures, "prey_sighted/mod", H.factory_passive(&"prey_sighted") != null)


static func run_barrage(failures: Array[String]) -> void:
	H.assert_true(failures, "barrage/mod", H.factory_passive(&"barrage") != null)


static func run_target_painter(failures: Array[String]) -> void:
	H.assert_true(failures, "target_painter/mod", H.factory_passive(&"target_painter") != null)


static func run_rapid_fire(failures: Array[String]) -> void:
	H.assert_true(failures, "rapid_fire/mod", H.factory_passive(&"rapid_fire") != null)
