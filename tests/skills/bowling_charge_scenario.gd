...
## Bible: Bowling Charge â€” DASH 3 | collision ATK/PUSH via BULLDOZE | [+] PUSH_CHAIN_COLLISION.
## Globals: DASH, BULLDOZE, PUSH_CHAIN_COLLISION via AbilitySystem / PhysicsSystem.
## Tier 1: sim contract + bowling planning intent E2E (Knight QA â€” not planning gate).
