...
## Bible: Defensive Formation â€” RANGE 0 | AOE 3 | Allies in range +2 DEF and immune PUSH/PULL 1 turn. [+] Allies also gain SHIELD 2.
...
static func run_all(failures: Array[String]) -> void:
	...
	_KnightQaHarness.run_planning_commit_smoke(
		failures, &"knight_defensive_formation", "formation", PlanningChecklistHarness.KNIGHT_START,
	)
