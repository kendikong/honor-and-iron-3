...
## Run: godot --headless --path . -s res://tests/runners/run_extra_rules_conversion_contract.gd
...
func _initialize() -> void:
	...
	var contract: Script = load("res://tests/harness/extra_rules_conversion_contract.gd") as Script
